...
from numpy import mean, std  #for kfold
...
vec_len = 1024   # 256 1024  2048  4096   8192  16384   32768
...
class DataGenerator(keras.utils.Sequence):  # on   dragon2 (tested)    #DataGenerator('train', train_idx, Y_train, 32, vec_len, shuffle=True)
  ...
  def __getitem__(self, index):
    ...
    #batch_x = [X_batch, dyadic_filter(X_batch, 2)]
...
model = Model(inputs = channel_1, outputs = out) 
...
filepath = './weights_folder/kfold_single_2'
