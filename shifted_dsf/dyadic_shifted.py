...
class DataGenerator(keras.utils.Sequence):  # on   dragon2 (tested)    #DataGenerator('train', train_idx, Y_train, 32, vec_len, shuffle=True)
  ...
  def __getitem__(self, index):
    ...
    batch_x = [X_batch, dyadic_filter(X_batch, 2), dyadic_filter(X_batch, 4, shifted = 1), dyadic_filter(X_batch, 8), dyadic_filter(X_batch, 16, shifted = 1), 
...
filepath = './weights_folder/fusion_shifted_4096_2'
